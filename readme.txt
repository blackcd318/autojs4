...
25.2023-07-24 这次修改是因为我在一个脚本截图搜索时总是会莫名其妙的退出,其实发现这问题很长世间了,只不过换成debug版本后就基本不出问题了,release下又不会出提示,所以一直就放着了,这次是实在有点忍受不了了,就从js函数一步步的看了上去,修改了一个地方,我自己测试了一下,原来截图搜索4000多次时autojs就会退出,这次我试到了17000+还没退出,改好没是不知道,不过起码是比原来好些了.
